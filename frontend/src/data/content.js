...
export const TEAM = {
  ...
  members: [
    ...
    },
    {
      ...
      role: "Team Leader",
      bio: "Deborah brings extensive experience working with children, young people, and families in both educational and community settings. She has supported children with special educational needs (SEN) in group and one-to-one environments, with a strong focus on safeguarding, managing challenging behaviour, and promoting positive development. She holds a wide range of professional training, including Safeguarding (Levels 1 & 2), Health & Safety, First Aid, Mental Health Awareness, and specialist training in areas such as autism, child exploitation, and supporting young people at risk. Deborah is reliable, compassionate, and committed to creating safe, supportive environments for those in her care. Enrolled in NVQ 5.",
    },
    {
      id: "linda-madimutsa",
      photoKey: "linda",
      ...
      role: "Team Leader",
      bio: "Linda is an experienced and dedicated care professional with over a decade of hands-on experience supporting vulnerable adults, young people, and those with complex needs. She has worked across residential, mental health, and community care settings, delivering person-centred support with compassion and professionalism. Holding a Bachelor's degree in Education and an NVQ Level 5 in Leadership and Management, Linda combines strong academic knowledge with practical expertise in care planning, safeguarding, and supporting individuals with dignity and respect. She has also completed extensive specialist training, including safeguarding children and adults, first aid, psychological first aid, mental health awareness, risk assessment, and working with young people at risk of exploitation, abuse, or challenging circumstances. Passionate about improving lives, Linda is committed to maintaining the highest standards of care, fostering inclusive environments, and empowering people to reach their full potential.",
    },
    {
      id: "shirley-bennett",
      photoKey: "shirley",
      name: "Shirley Cecile Bennett",
      role: "Team Leader for 18+ Supported Living",
