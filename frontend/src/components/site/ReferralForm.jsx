    ...
    <form onSubmit={handleSubmit} data-testid="referral-form" className="rounded-3xl bg-white p-8 lg:p-10 shadow-2xl shadow-[var(--rc-indigo-900)]/10">
      ...
      <div className="mt-6 space-y-4">
        <div className="grid sm:grid-cols-2 gap-4">
          <input data-testid="referral-name-input" required value={form.name} onChange={setField("name")} placeholder="Your Name *" className="rc-input" />
          <input data-testid="referral-email-input" required type="email" value={form.email} onChange={setField("email")} placeholder="Your Email *" className="rc-input" />
        </div>
        <div className="grid sm:grid-cols-2 gap-4">
          <input data-testid="referral-phone-input" required type="tel" value={form.phone} onChange={setField("phone")} placeholder="Your Phone *" className="rc-input" />
          <input data-testid="referral-organisation-input" value={form.organisation} onChange={setField("organisation")} placeholder="Organisation / Local Authority" className="rc-input" />
        </div>
        <select
